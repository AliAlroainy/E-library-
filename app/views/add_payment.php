...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> اضافة طريقة دفع</h4>
    ...
    <div class="row g-3">
      ...
      <div class="col-md-6">
        <div class="form-password-toggle">
          <label class="form-label" for="multicol-confirm-password">تفعيل البطاقة</label>
          <div class="input-group input-group-merge">
          <label class="switch">
