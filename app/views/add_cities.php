...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> اضافة مؤلف</h4>
...
<div class="card mb-4">
  <h5 class="card-header">اضافة عنوان جديد</h5>
  <form class="card-body" action="/save_cities" method="POST" enctype="multipart/form-data">
    
    <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">العنوان</label>
        <input name="cities_name" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
